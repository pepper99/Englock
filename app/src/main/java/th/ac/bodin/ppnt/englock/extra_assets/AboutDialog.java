...
public class AboutDialog extends DialogFragment {
    ...
    public static AboutDialog newInstance(String message, @StringRes int button, @StringRes int layout) {
    ...
    public static class Builder {
        ...
        public AboutDialog build() {
            AboutDialog fragment = AboutDialog.newInstance(message, button, layout);
